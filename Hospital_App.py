...
#Model dimuat sekali kita codenya dijalankan
# readbinary(rb)
@st.cache_resource
def load_model():
...
with st.form("triage_form"):
    ...
    """, unsafe_allow_html=True)
    #index 1 agar di dropdown udah ada valuenya; sebagai nilai default ketika dibuka
